...
ALTER TABLE `PREFIX_access`
  ADD FOREIGN KEY `fk_access_profile`(`id_profile`)
REFERENCES `PREFIX_profile` (`id_profile`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_accessory`
  ADD FOREIGN KEY `fk_accessory_product_1`(`id_product_1`)
REFERENCES `PREFIX_product` (`id_product`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_accessory`
  ADD FOREIGN KEY `fk_accessory_product_2`(`id_product_2`)
REFERENCES `PREFIX_product` (`id_product`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_address`
  ADD FOREIGN KEY `fk_address_country`(`id_country`)
REFERENCES `PREFIX_country` (`id_country`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_address`
  ADD FOREIGN KEY `fk_address_state`(`id_state`)
REFERENCES `PREFIX_state` (`id_state`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_address`
  ADD FOREIGN KEY `fk_address_customer`(`id_customer`)
REFERENCES `PREFIX_customer` (`id_customer`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_address`
  ADD FOREIGN KEY `fk_address_manufacturer`(`id_manufacturer`)
REFERENCES `PREFIX_manufacturer` (`id_manufacturer`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_address`
  ADD FOREIGN KEY `fk_address_supplier`(`id_supplier`)
REFERENCES `PREFIX_supplier` (`id_supplier`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_address`
  ADD FOREIGN KEY `fk_address_warehouse`(`id_warehouse`)
REFERENCES `PREFIX_warehouse` (`id_warehouse`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_attachment_lang`
  ADD FOREIGN KEY `fk_attachment_lang_attachment`(`id_attachment`)
REFERENCES `PREFIX_attachment` (`id_attachment`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_attachment_lang`
  ADD FOREIGN KEY `fk_attachment_lang_lang`(`id_lang`)
REFERENCES `PREFIX_lang` (`id_lang`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_product_attachment`
  ADD FOREIGN KEY `fk_product_attachment_product`(`id_product`)
REFERENCES `PREFIX_product` (`id_product`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_product_attachment`
  ADD FOREIGN KEY `fk_product_attachment_attachment`(`id_attachment`)
REFERENCES `PREFIX_attachment` (`id_attachment`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_attribute`
  ADD FOREIGN KEY `fk_attribute_attribute_group`(`id_attribute_group`)
REFERENCES `PREFIX_attribute_group` (`id_attribute_group`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_attribute_group_lang`
  ADD FOREIGN KEY `fk_attribute_group_lang_attribute_group` (`id_attribute_group`)
REFERENCES `PREFIX_attribute_group` (`id_attribute_group`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_attribute_impact`
  ADD FOREIGN KEY `fk_attribute_impact_product`(`id_product`)
REFERENCES `PREFIX_product` (`id_product`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_attribute_impact`
  ADD FOREIGN KEY `fk_attribute_impact_attribute`(`id_attribute`)
REFERENCES `PREFIX_attribute` (`id_attribute`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_attribute_lang`
  ADD FOREIGN KEY `fk_attribute_lang_lang`(`id_lang`)
REFERENCES `PREFIX_lang` (`id_lang`)
  ON DELETE CASCADE;

ALTER TABLE `PREFIX_carrier_lang`
  ADD FOREIGN KEY `fk_carrier_lang_carrier`(`id_carrier`)
REFERENCES `PREFIX_carrier` (`id_carrier`);

ALTER TABLE `PREFIX_carrier_lang`
  ADD FOREIGN KEY `fk_carrier_lang_shop`(`id_shop`)
REFERENCES `PREFIX_shop` (`id_shop`);

ALTER TABLE `PREFIX_carrier_lang`
  ADD FOREIGN KEY `fk_carrier_lang_lang`(`id_lang`)
REFERENCES `PREFIX_lang` (`id_lang`);

ALTER TABLE `PREFIX_carrier_zone`
  ADD FOREIGN KEY `fk_carrier_zone_carrier`(`id_carrier`)
REFERENCES `PREFIX_carrier` (`id_carrier`);

ALTER TABLE `PREFIX_carrier_zone`
  ADD FOREIGN KEY `fk_carrier_zone_zone`(`id_zone`)
REFERENCES `PREFIX_zone` (`id_zone`);
